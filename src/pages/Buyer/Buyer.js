    ...
    <div className="buyer">
      <div>
        <div className="buyer__img">
          <img src='http://dealeraccelerate-all.s3.amazonaws.com/international/marketing_assets/13/banner5.jpg' alt="" />
        </div>
        <div>
          <h4>CALIFORNIA</h4>
          <p>If you are in California and you want a legal to drive, over 25 year old vehicle like a Nissan Skyline GT-R, you know it's not as simple as the rest of the country. Toprank Importers have navigated this obstacle , and can offer JDM, or other foreign cars, fully legal for California. California compliance testing, and smog testing (in use testing) are not the same. A direct import vehicle must pass compliance testing, then in addition pass smog testing to be legally registered in California. </p>
        </div>
      </div>
      <div className="buyer__sticker-container">
        ...
        <div className="buyer__sticker-bio">
          <p>Prices for California modification and testing range from $7500 - $15000 depending on vehicle model and condition up to 1995. R32 and R33 Nissan Skyline GT-R are typically $11,000. The cars need to be near stock, and in perfect running order.  1996 and up can require OBD II, which adds significantly to the cost and complexity. Please call or email us with specific cost questions. 844-523-2233 or sales@importavehicle.com</p>
          <p>
            <span>1967 model year vehicles and older -</span>
            no modifications and testing are required to register the vehicle in California.
          </p>
          <p>
            <span>1968 model year to 1974 model year vehicles -</span>
            California does not recommend the purchase or importation of these years of NON-USA vehicles, even if currently registered in another state. These vehicles require compliance with USEPA requirements in effect on the specific date of 11/15/1972. This provision when written, was considered by the California legislature as a gradual phase-out of very dirty "non-collectable" types of imports, as this specific requirement was understood to become increasingly difficult to meet. Today, this requirement, while not impossible to meet, would require testing expenses and modifications that far exceed most vehicles value and would make little sense from a collectors standpoint to attempt. The limited exemptions that could have applied to individuals moving to California were closed by
            <span>VIN 2017-15 (Direct Import Vehicles Update) </span> Contact the DMV for more information.
          </p>
          <p>
            <span>1975 model year vehicles to the present -</span>
          ...
          <p>
            <span>Motorcycles and heavy-duty engines -</span>
            (used in trucks and buses) are required to comply with CA or USEPA from the date of manufacturer, no after-the-fact modification is permitted for products first sold outside the US market.
          </p>
          <p>
          ...
          <div>
            <span>2) What are direct import vehicles?</span>
            <p>
          ...
          <div>
            <span>3) What is a used direct import vehicle?</span>
            <p>
          ...
          <div>
            <span>4) What vehicles may be registered in California without certification?</span>
            <p>
          ...
          <div>
            <span>5) I have a 1974 vehicle that I want to import, can I register it in California.</span>
            <p>
              A - Not without meeting EPA requirements as defined here -
              <span>http://www.importavehicle.info/2014/12/california-certification-procedures-for.html</span>
            </p>
            <p>
              <span>1968 model year to 1974 model year vehicles:</span>
              California does not recommend the purchase or importation of these years of NON-USA vehicles, even if currently registered in another state. These vehicles require compliance with USEPA requirements in effect on the specific date of 11/15/1972. This provision when written, was considered by the California legislature as a gradual phase-out of very dirty non-collectable types of imports, as this specific requirement was understood to become increasingly difficult to meet. Today, this requirement, while not impossible to meet, would require testing expenses and modifications that far exceed most vehicles value and would make little sense from a collectors standpoint to attempt. The limited exemptions that could have applied to individuals moving to California were closed by
              <span> VIN 2017-15 (Direct Import Vehicles Update) </span>
              Contact us for more information.
            </p>
          </div>
          <div>
            <span>6) What year non US spec vehicles are exempt from California emissions requirements?</span>
            <p>
              A - <span>1967 model year vehicles and older:</span> 
              no modifications and testing are required to register the vehicle in California.
            </p>
          </div>
          <div>
            <span>7) What about diesel vehicles into California?</span>
            <p>
          ...
          <div>
            <span>8) How about importing motorcycles?</span>
            <p>
              <strong>Motorcycles</strong>
              <span>are required to comply with CA or USEPA from the date of manufacturer, no after-the-fact modification is permitted for products first sold outside the US market.</span>
            </p>
          </div>
          <div>
            <span>8) Once brought into California compliance, which vehicles do not require a biennial smog check?</span>
            <p>
              ...
              <span>Smog Check FAQ at the Bureau of Automotive Repair (BAR)</span>
            </p>
          </div>
        </div>
      </div>
